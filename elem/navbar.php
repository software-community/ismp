...
<nav class="navbar bg-white sticky-top navbar-expand-lg" color-on-scroll="100" id="sectionsNav">
  <div class="container">
    <div class="navbar-translate">
      <a class="navbar-brand" href="<?php echo "$root_path"; ?>index.php">
        <div class="row">
          <img src="<?php echo "$root_path"; ?>images/logo/logo.png" class="img-fluid" style="margin-top: -15px; margin-left:30px; margin-right: 30px; width:150px;">
        </div>
      </a>
